...
class WHEATDetection(data.Dataset):
    ...
    def __init__(self, 
                 root='/kaggle/working/',
                 image_sets='train',
                 transform=None, target_transform=WHEATAnnotationTransform(),
                 dataset_name='WHEAT'):
        self.root = root
        ...
        self._imgpath = '/kaggle/input/global-wheat-detection/train/'
        self.ids = list()
...
#         print(target)
    ...
    def pull_image(self, index):
        ...
        '''
        img_id = self.ids[index]
        return cv2.imread(f"{self._imgpath}{img_id}.jpg", cv2.IMREAD_COLOR)
    ...
    def pull_anno(self, index):
        ...
        '''
        img_id = self.ids[index]
        anno = ET.parse(f"{self._annopath}{img_id}.xml").getroot()
